class LyricsGenerator {
    constructor() {
        this.apiBaseUrl = 'https://api.pmelody.top/api/lyrics';
    ...
    async generateLyrics() {
        ...
        try {
            ...
            const deductResponse = await fetch('https://api.pmelody.top/api/auth/deduct-points', {
                method: 'POST',
                headers: {
            ...
            if (result.success) {
                ...
                try {
                    await fetch('https://api.pmelody.top/api/auth/refund-points', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': `Bearer ${localStorage.getItem('authToken')}`
