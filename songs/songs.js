class SongsGenerator {
    ...
    async checkWalletAndPoints() {
        ...
        try {
            ...
            console.log('🌐 [DEBUG] Sending wallet verification request to: https://api.pmelody.top/api/auth/verify-wallet');
            const verifyResponse = await fetch('https://api.pmelody.top/api/auth/verify-wallet', {
                method: 'GET',
                headers: {
            ...
            console.log('🌐 [DEBUG] Sending points query request to: https://api.pmelody.top/api/auth/check-points');
            const pointsResponse = await fetch('https://api.pmelody.top/api/auth/check-points', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${authToken}`
                }
    ...
    async deductPoints() {
        try {
            ...
            console.log('🌐 [DEBUG] Sending points deduction request to: https://api.pmelody.top/api/auth/deduct-points');
            const response = await fetch('https://api.pmelody.top/api/auth/deduct-points', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${authToken}`
    ...
    async refundPoints() {
        ...
        try {
            ...
            console.log('🌐 [DEBUG] Sending points refund request to: https://api.pmelody.top/api/auth/refund-points');
            const response = await fetch('https://api.pmelody.top/api/auth/refund-points', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${authToken}`
