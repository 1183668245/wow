...
async function addUserPoints(taskId, points) {
    ...
    try {
        ...
        const response = await fetch('https://api.pmelody.top/api/users/add-points', {
            method: 'POST',
            headers: {
...
async function copyWebsiteLink() {
    ...
    const websiteUrl = "https://pmelody.top/";
    try {
            ...
            <div class="task-list">
                ...
                <div class="task-item">
                    <div class="task-info">
                        ...
                        <p>Tag @PMelody_Plasma and copy the contract to earn 5 points for free!</p>
                    </div>
